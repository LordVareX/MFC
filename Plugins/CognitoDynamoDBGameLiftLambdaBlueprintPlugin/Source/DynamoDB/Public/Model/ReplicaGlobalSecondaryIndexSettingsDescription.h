...
public:
    FReplicaGlobalSecondaryIndexSettingsDescription &fromAWS(const Aws::DynamoDB::Model::ReplicaGlobalSecondaryIndexSettingsDescription &awsReplicaGlobalSecondaryIndexSettingsDescription) {
        ...
        this->provisionedReadCapacityUnits = (int)awsReplicaGlobalSecondaryIndexSettingsDescription.GetProvisionedReadCapacityUnits();
        ...
        this->provisionedWriteCapacityUnits = (int)awsReplicaGlobalSecondaryIndexSettingsDescription.GetProvisionedWriteCapacityUnits();
