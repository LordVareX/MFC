...
GENERATED_BODY()
    ...
    **/
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "DynamoDB Client")
    int replicaProvisionedWriteCapacityUnits;
...
public:
    FReplicaSettingsDescription &fromAWS(const Aws::DynamoDB::Model::ReplicaSettingsDescription &awsReplicaSettingsDescription) {
        ...
        this->replicaProvisionedReadCapacityUnits = (int)awsReplicaSettingsDescription.GetReplicaProvisionedReadCapacityUnits();
        ...
        this->replicaProvisionedWriteCapacityUnits = (int)awsReplicaSettingsDescription.GetReplicaProvisionedWriteCapacityUnits();
