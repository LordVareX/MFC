...
public:
    ...
    bool IsEmpty() const {
        return this->userPoolId.IsEmpty() && this->policies.IsEmpty() && this->lambdaConfig.IsEmpty() && this->autoVerifiedAttributes.Num() == 0 && this->smsVerificationMessage.IsEmpty() && this->emailVerificationMessage.IsEmpty() && this->emailVerificationSubject.IsEmpty() && this->verificationMessageTemplate.IsEmpty() && this->smsAuthenticationMessage.IsEmpty() && this->mfaConfiguration == EUserPoolMfaType::NOT_SET && this->deviceConfiguration.IsEmpty() && this->emailConfiguration.IsEmpty() && this->smsConfiguration.IsEmpty() && this->userPoolTags.Num() == 0 && this->adminCreateUserConfig.IsEmpty() && this->userPoolAddOns.IsEmpty();
    }
#endif
};
