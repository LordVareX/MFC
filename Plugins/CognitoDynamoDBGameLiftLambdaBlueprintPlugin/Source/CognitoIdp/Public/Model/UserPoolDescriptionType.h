...
public:
    FUserPoolDescriptionType &fromAWS(const Aws::CognitoIdentityProvider::Model::UserPoolDescriptionType &awsUserPoolDescriptionType) {
        ...
        this->lastModifiedDate = FDateTime::FromUnixTimestamp(awsUserPoolDescriptionType.GetLastModifiedDate().Millis());

        this->creationDate = FDateTime::FromUnixTimestamp(awsUserPoolDescriptionType.GetCreationDate().Millis());
