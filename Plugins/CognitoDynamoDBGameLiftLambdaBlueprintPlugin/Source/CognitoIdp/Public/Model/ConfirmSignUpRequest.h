...
public:
    ...
    bool IsEmpty() const {
        return this->clientId.IsEmpty() && this->secretHash.IsEmpty() && this->username.IsEmpty() && this->confirmationCode.IsEmpty() && false && this->analyticsMetadata.IsEmpty() && this->userContextData.IsEmpty();
    }
#endif
};
