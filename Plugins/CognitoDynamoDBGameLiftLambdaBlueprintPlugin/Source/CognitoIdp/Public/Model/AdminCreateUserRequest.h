...
public:
    ...
    bool IsEmpty() const {
        return this->userPoolId.IsEmpty() && this->username.IsEmpty() && this->userAttributes.Num() == 0 && this->validationData.Num() == 0 && this->temporaryPassword.IsEmpty() && false && this->messageAction == EMessageActionType::NOT_SET && this->desiredDeliveryMediums.Num() == 0;
    }
#endif
};
