...
public:
    FUserType &fromAWS(const Aws::CognitoIdentityProvider::Model::UserType &awsUserType) {
        ...
        this->userCreateDate = FDateTime::FromUnixTimestamp(awsUserType.GetUserCreateDate().Millis());

        this->userLastModifiedDate = FDateTime::FromUnixTimestamp(awsUserType.GetUserLastModifiedDate().Millis());
