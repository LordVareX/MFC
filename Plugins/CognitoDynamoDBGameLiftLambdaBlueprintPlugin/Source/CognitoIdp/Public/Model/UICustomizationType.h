...
public:
    FUICustomizationType &fromAWS(const Aws::CognitoIdentityProvider::Model::UICustomizationType &awsUICustomizationType) {
        ...
        this->lastModifiedDate = FDateTime::FromUnixTimestamp(awsUICustomizationType.GetLastModifiedDate().Millis());

        this->creationDate = FDateTime::FromUnixTimestamp(awsUICustomizationType.GetCreationDate().Millis());
