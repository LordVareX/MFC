...
public:
    FGroupType &fromAWS(const Aws::CognitoIdentityProvider::Model::GroupType &awsGroupType) {
        ...
        this->lastModifiedDate = FDateTime::FromUnixTimestamp(awsGroupType.GetLastModifiedDate().Millis());

        this->creationDate = FDateTime::FromUnixTimestamp(awsGroupType.GetCreationDate().Millis());
