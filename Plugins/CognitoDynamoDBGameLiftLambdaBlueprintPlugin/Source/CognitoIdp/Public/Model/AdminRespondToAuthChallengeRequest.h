...
public:
    ...
    bool IsEmpty() const {
        return this->userPoolId.IsEmpty() && this->clientId.IsEmpty() && this->challengeName == EChallengeNameType::NOT_SET && this->challengeResponses.Num() == 0 && this->session.IsEmpty() && this->analyticsMetadata.IsEmpty() && this->contextData.IsEmpty();
    }
#endif
};
