...
public:
    FAdminGetUserResult &fromAWS(const Aws::CognitoIdentityProvider::Model::AdminGetUserResult &awsAdminGetUserResult) {
        ...
        this->userCreateDate = FDateTime::FromUnixTimestamp(awsAdminGetUserResult.GetUserCreateDate().Millis());

        this->userLastModifiedDate = FDateTime::FromUnixTimestamp(awsAdminGetUserResult.GetUserLastModifiedDate().Millis());
