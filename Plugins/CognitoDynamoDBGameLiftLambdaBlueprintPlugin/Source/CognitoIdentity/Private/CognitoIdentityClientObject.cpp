...
UCognitoIdentityClientObject *UCognitoIdentityClientObject::CreateCognitoIdentityObject(
    ...
    CognitoIdentityClient->awsCognitoIdentityClient = new Aws::CognitoIdentity::CognitoIdentityClient(
            credentials.toAWS(),
...
FString UCognitoIdentityClientObject::GetServiceClientName() const {
#if WITH_COGNITOIDENTITYCLIENTSDK && WITH_CORE
    return this->awsCognitoIdentityClient->GetServiceClientName();
#endif
    return FString();
}
    ...
    FCreateIdentityPoolAction(
        ...
        CognitoIdentityClient->CreateIdentityPoolAsync(
                ...
                [&success, &createIdentityPoolResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsCreateIdentityPoolOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
...
UCognitoIdentityClientObject::CreateIdentityPool(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        ...
        if (LatentActionManager.FindExistingAction<FCreateIdentityPoolAction>(LatentInfo.CallbackTarget,
    ...
    FDeleteIdentitiesAction(
        ...
        CognitoIdentityClient->DeleteIdentitiesAsync(
                ...
                [&success, &deleteIdentitiesResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsDeleteIdentitiesOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::DeleteIdentities(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FDeleteIdentitiesAction>(LatentInfo.CallbackTarget,
                                                                            LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FDeleteIdentityPoolAction(
        ...
        CognitoIdentityClient->DeleteIdentityPoolAsync(
                ...
                [&success, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsDeleteIdentityPoolOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::DeleteIdentityPool(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FDeleteIdentityPoolAction>(LatentInfo.CallbackTarget,
                                                                              LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FDescribeIdentityAction(
        ...
        CognitoIdentityClient->DescribeIdentityAsync(
                ...
                [&success, &describeIdentityResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsDescribeIdentityOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::DescribeIdentity(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FDescribeIdentityAction>(LatentInfo.CallbackTarget,
                                                                            LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FDescribeIdentityPoolAction(
        ...
        CognitoIdentityClient->DescribeIdentityPoolAsync(
                ...
                [&success, &describeIdentityPoolResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsDescribeIdentityPoolOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::DescribeIdentityPool(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FDescribeIdentityPoolAction>(LatentInfo.CallbackTarget,
                                                                                LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FGetCredentialsForIdentityAction(
        ...
        CognitoIdentityClient->GetCredentialsForIdentityAsync(
                ...
                [&success, &getCredentialsForIdentityResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsGetCredentialsForIdentityOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::GetCredentialsForIdentity(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FGetCredentialsForIdentityAction>(LatentInfo.CallbackTarget,
                                                                                     LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FGetIdAction(
        ...
        CognitoIdentityClient->GetIdAsync(
                ...
                [&success, &getIdResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsGetIdOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
    ...
    FGetIdentityPoolRolesAction(
        ...
        CognitoIdentityClient->GetIdentityPoolRolesAsync(
                ...
                [&success, &getIdentityPoolRolesResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsGetIdentityPoolRolesOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::GetIdentityPoolRoles(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FGetIdentityPoolRolesAction>(LatentInfo.CallbackTarget,
                                                                                LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FGetOpenIdTokenAction(
        ...
        CognitoIdentityClient->GetOpenIdTokenAsync(
                ...
                [&success, &getOpenIdTokenResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsGetOpenIdTokenOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::GetOpenIdToken(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FGetOpenIdTokenAction>(LatentInfo.CallbackTarget, LatentInfo.UUID) ==
            NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FGetOpenIdTokenForDeveloperIdentityAction(
        ...
        CognitoIdentityClient->GetOpenIdTokenForDeveloperIdentityAsync(
                ...
                [&success, &getOpenIdTokenForDeveloperIdentityResult, &errorType, &errorMessage, this](
                    ...
                    if (success) {
                        getOpenIdTokenForDeveloperIdentityResult.fromAWS(
                                awsGetOpenIdTokenForDeveloperIdentityOutcome.GetResult());
                    }

                    errorType = fromAWS(awsGetOpenIdTokenForDeveloperIdentityOutcome.GetError().GetErrorType());
                    errorMessage = awsGetOpenIdTokenForDeveloperIdentityOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::GetOpenIdTokenForDeveloperIdentity(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FGetOpenIdTokenForDeveloperIdentityAction>(LatentInfo.CallbackTarget,
                                                                                              LatentInfo.UUID) ==
            NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
                                             new FGetOpenIdTokenForDeveloperIdentityAction(
                                                     this->awsCognitoIdentityClient,
                                                     success,
    ...
    FListIdentitiesAction(
        ...
        CognitoIdentityClient->ListIdentitiesAsync(
                ...
                [&success, &listIdentitiesResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsListIdentitiesOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::ListIdentities(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FListIdentitiesAction>(LatentInfo.CallbackTarget, LatentInfo.UUID) ==
            NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FListIdentityPoolsAction(
        ...
        CognitoIdentityClient->ListIdentityPoolsAsync(
                ...
                [&success, &listIdentityPoolsResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsListIdentityPoolsOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::ListIdentityPools(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FListIdentityPoolsAction>(LatentInfo.CallbackTarget,
                                                                             LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FLookupDeveloperIdentityAction(
        ...
        CognitoIdentityClient->LookupDeveloperIdentityAsync(
                ...
                [&success, &lookupDeveloperIdentityResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsLookupDeveloperIdentityOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::LookupDeveloperIdentity(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FLookupDeveloperIdentityAction>(LatentInfo.CallbackTarget,
                                                                                   LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FMergeDeveloperIdentitiesAction(
        ...
        CognitoIdentityClient->MergeDeveloperIdentitiesAsync(
                ...
                [&success, &mergeDeveloperIdentitiesResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsMergeDeveloperIdentitiesOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::MergeDeveloperIdentities(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FMergeDeveloperIdentitiesAction>(LatentInfo.CallbackTarget,
                                                                                    LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FSetIdentityPoolRolesAction(
        ...
        CognitoIdentityClient->SetIdentityPoolRolesAsync(
                ...
                [&success, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsSetIdentityPoolRolesOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::SetIdentityPoolRoles(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FSetIdentityPoolRolesAction>(LatentInfo.CallbackTarget,
                                                                                LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FUnlinkDeveloperIdentityAction(
        ...
        CognitoIdentityClient->UnlinkDeveloperIdentityAsync(
                ...
                [&success, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsUnlinkDeveloperIdentityOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::UnlinkDeveloperIdentity(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FUnlinkDeveloperIdentityAction>(LatentInfo.CallbackTarget,
                                                                                   LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FUnlinkIdentityAction(
        ...
        CognitoIdentityClient->UnlinkIdentityAsync(
                ...
                [&success, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsUnlinkIdentityOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::UnlinkIdentity(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FUnlinkIdentityAction>(LatentInfo.CallbackTarget, LatentInfo.UUID) ==
            NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
    ...
    FUpdateIdentityPoolAction(
        ...
        CognitoIdentityClient->UpdateIdentityPoolAsync(
                ...
                [&success, &updateIdentityPoolResult, &errorType, &errorMessage, this](
                    ...
                    errorMessage = awsUpdateIdentityPoolOutcome.GetError().GetMessage().c_str();
                    completed = true;
                },
                std::make_shared<Aws::Client::AsyncCallerContext>(std::to_string(LatentInfo.UUID).c_str())
        );
...
UCognitoIdentityClientObject::UpdateIdentityPool(
    ...
    if (UWorld *World = GEngine->GetWorldFromContextObject(WorldContextObject, EGetWorldErrorMode::Assert)) {
        FLatentActionManager &LatentActionManager = World->GetLatentActionManager();
        if (LatentActionManager.FindExistingAction<FUpdateIdentityPoolAction>(LatentInfo.CallbackTarget,
                                                                              LatentInfo.UUID) == NULL) {
            LatentActionManager.AddNewAction(LatentInfo.CallbackTarget, LatentInfo.UUID,
