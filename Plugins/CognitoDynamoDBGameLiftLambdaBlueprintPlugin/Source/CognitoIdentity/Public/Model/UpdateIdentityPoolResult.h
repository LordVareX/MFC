...
public:
    FUpdateIdentityPoolResult &fromAWS(const Aws::CognitoIdentity::Model::UpdateIdentityPoolResult &awsUpdateIdentityPoolResult) {
        ...
        for (const std::pair<Aws::String, Aws::String>& elem : awsUpdateIdentityPoolResult.GetSupportedLoginProviders()) {
        ...
        for (const std::pair<Aws::String, Aws::String>& elem : awsUpdateIdentityPoolResult.GetIdentityPoolTags()) {
