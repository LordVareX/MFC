...
public:
    ...
    bool IsEmpty() const {
        return this->identityPoolId.IsEmpty() && this->identityPoolName.IsEmpty() && false && this->supportedLoginProviders.Num() == 0 && this->developerProviderName.IsEmpty() && this->openIdConnectProviderARNs.Num() == 0 && this->cognitoIdentityProviders.Num() == 0 && this->samlProviderARNs.Num() == 0 && this->identityPoolTags.Num() == 0;
    }
#endif
};
