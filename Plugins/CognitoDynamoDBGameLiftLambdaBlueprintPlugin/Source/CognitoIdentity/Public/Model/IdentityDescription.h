...
public:
    FIdentityDescription &fromAWS(const Aws::CognitoIdentity::Model::IdentityDescription &awsIdentityDescription) {
        ...
        this->creationDate = FDateTime::FromUnixTimestamp(awsIdentityDescription.GetCreationDate().Millis());

        this->lastModifiedDate = FDateTime::FromUnixTimestamp(awsIdentityDescription.GetLastModifiedDate().Millis());
