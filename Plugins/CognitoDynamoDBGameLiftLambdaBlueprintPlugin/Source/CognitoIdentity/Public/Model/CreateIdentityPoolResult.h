...
public:
    FCreateIdentityPoolResult &fromAWS(const Aws::CognitoIdentity::Model::CreateIdentityPoolResult &awsCreateIdentityPoolResult) {
        ...
        for (const std::pair<Aws::String, Aws::String>& elem : awsCreateIdentityPoolResult.GetSupportedLoginProviders()) {
        ...
        for (const std::pair<Aws::String, Aws::String>& elem : awsCreateIdentityPoolResult.GetIdentityPoolTags()) {
