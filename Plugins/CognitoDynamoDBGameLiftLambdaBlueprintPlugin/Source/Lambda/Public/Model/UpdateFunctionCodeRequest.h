...
public:
    ...
    bool IsEmpty() const {
        return this->functionName.IsEmpty() && !FPlatformFileManager::Get().GetPlatformFile().FileExists(*this->zipFile) && this->s3Bucket.IsEmpty() && this->s3Key.IsEmpty() && this->s3ObjectVersion.IsEmpty() && false && false && this->revisionId.IsEmpty();
    }
#endif
};
