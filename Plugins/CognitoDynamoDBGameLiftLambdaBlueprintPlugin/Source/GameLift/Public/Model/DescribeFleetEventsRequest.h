...
public:
    Aws::GameLift::Model::DescribeFleetEventsRequest toAWS() const {
        ...
        awsDescribeFleetEventsRequest.SetStartTime(Aws::Utils::DateTime((int64_t)this->startTime.ToUnixTimestamp()));

        awsDescribeFleetEventsRequest.SetEndTime(Aws::Utils::DateTime((int64_t)this->endTime.ToUnixTimestamp()));
