...
public:
    ...
    bool IsEmpty() const {
        return this->awsResourceName.IsEmpty() && this->maximumPlayerSessionCount == 0 && this->name.IsEmpty() && this->gameProperties.Num() == 0 && this->creatorId.IsEmpty() && this->gameSessionId.IsEmpty() && this->idempotencyToken.IsEmpty() && this->gameSessionData.IsEmpty();
    }
#endif
};
