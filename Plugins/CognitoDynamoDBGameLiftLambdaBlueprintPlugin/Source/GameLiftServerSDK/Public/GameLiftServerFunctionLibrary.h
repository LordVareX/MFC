...
public:
    ...
    */
    ...
    static void TerminateGameSession(bool &success, EGameLiftServerError &errorType, FString &errorMessage);
   ...
   */
    ...
    */
    ...
    static void
    StopMatchBackfill(bool &success, EGameLiftServerError &errorType, FString &errorMessage, const FStopMatchBackfillRequest &stopMatchBackfillRequest);
