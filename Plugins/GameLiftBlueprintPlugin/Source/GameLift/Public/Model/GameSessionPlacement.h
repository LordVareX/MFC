...
public:
    FGameSessionPlacement &fromAWS(const Aws::GameLift::Model::GameSessionPlacement &awsGameSessionPlacement) {
        this->placementId = awsGameSessionPlacement.GetPlacementId().c_str();

        this->gameSessionQueueName = awsGameSessionPlacement.GetGameSessionQueueName().c_str();
        ...
        this->gameSessionName = awsGameSessionPlacement.GetGameSessionName().c_str();

        this->gameSessionId = awsGameSessionPlacement.GetGameSessionId().c_str();

        this->gameSessionArn = awsGameSessionPlacement.GetGameSessionArn().c_str();

        this->gameSessionRegion = awsGameSessionPlacement.GetGameSessionRegion().c_str();
        ...
        this->startTime = FDateTime::FromUnixTimestamp(awsGameSessionPlacement.GetStartTime().Millis());

        this->endTime = FDateTime::FromUnixTimestamp(awsGameSessionPlacement.GetEndTime().Millis());

        this->ipAddress = awsGameSessionPlacement.GetIpAddress().c_str();

        this->dnsName = awsGameSessionPlacement.GetDnsName().c_str();
        ...
        this->gameSessionData = awsGameSessionPlacement.GetGameSessionData().c_str();

        this->matchmakerData = awsGameSessionPlacement.GetMatchmakerData().c_str();
