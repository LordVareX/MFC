...
public:
    FVpcPeeringAuthorization &fromAWS(const Aws::GameLift::Model::VpcPeeringAuthorization &awsVpcPeeringAuthorization) {
        this->gameLiftAwsAccountId = awsVpcPeeringAuthorization.GetGameLiftAwsAccountId().c_str();

        this->peerVpcAwsAccountId = awsVpcPeeringAuthorization.GetPeerVpcAwsAccountId().c_str();

        this->peerVpcId = awsVpcPeeringAuthorization.GetPeerVpcId().c_str();

        this->creationTime = FDateTime::FromUnixTimestamp(awsVpcPeeringAuthorization.GetCreationTime().Millis());

        this->expirationTime = FDateTime::FromUnixTimestamp(awsVpcPeeringAuthorization.GetExpirationTime().Millis());
