...
public:
    FMatchmakingConfiguration &fromAWS(const Aws::GameLift::Model::MatchmakingConfiguration &awsMatchmakingConfiguration) {
        this->name = awsMatchmakingConfiguration.GetName().c_str();

        this->description = awsMatchmakingConfiguration.GetDescription().c_str();
        ...
        this->ruleSetName = awsMatchmakingConfiguration.GetRuleSetName().c_str();

        this->notificationTarget = awsMatchmakingConfiguration.GetNotificationTarget().c_str();

        this->additionalPlayerCount = awsMatchmakingConfiguration.GetAdditionalPlayerCount();

        this->customEventData = awsMatchmakingConfiguration.GetCustomEventData().c_str();
        ...
        this->gameSessionData = awsMatchmakingConfiguration.GetGameSessionData().c_str();
