    ...
    public:
        Aws::GameLift::Model::UpdateGameSessionRequest toAWS() const {
            ...
            switch(this->playerSessionCreationPolicy) {
                case EPlayerSessionCreationPolicy::NOT_SET:
                    awsUpdateGameSessionRequest.SetPlayerSessionCreationPolicy(Aws::GameLift::Model::PlayerSessionCreationPolicy::NOT_SET);
                    break;
            ...
            switch(this->protectionPolicy) {
                case EProtectionPolicy::NOT_SET:
                    awsUpdateGameSessionRequest.SetProtectionPolicy(Aws::GameLift::Model::ProtectionPolicy::NOT_SET);
                    break;
