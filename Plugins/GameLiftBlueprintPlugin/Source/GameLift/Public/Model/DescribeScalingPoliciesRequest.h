...
public:
    Aws::GameLift::Model::DescribeScalingPoliciesRequest toAWS() const {
        ...
        switch(this->statusFilter) {
            case EScalingStatusType::NOT_SET:
                awsDescribeScalingPoliciesRequest.SetStatusFilter(Aws::GameLift::Model::ScalingStatusType::NOT_SET);
                break;
    ...
    bool IsEmpty() const {
        return this->fleetId.IsEmpty() && this->statusFilter == EScalingStatusType::NOT_SET && this->limit == 0 && this->nextToken.IsEmpty();
    }
#endif
};
