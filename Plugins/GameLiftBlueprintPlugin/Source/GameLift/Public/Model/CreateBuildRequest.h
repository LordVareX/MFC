...
public:
    Aws::GameLift::Model::CreateBuildRequest toAWS() const {
        ...
        switch(this->operatingSystem) {
            case EOperatingSystem::NOT_SET:
                awsCreateBuildRequest.SetOperatingSystem(Aws::GameLift::Model::OperatingSystem::NOT_SET);
                break;
    ...
    bool IsEmpty() const {
        return this->name.IsEmpty() && this->version.IsEmpty() && this->storageLocation.IsEmpty() && this->operatingSystem == EOperatingSystem::NOT_SET;
    }
#endif
};
