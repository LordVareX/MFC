...
public:
    Aws::GameLift::Model::RoutingStrategy toAWS() const {
        ...
        switch(this->type) {
            case ERoutingStrategyType::NOT_SET:
                awsRoutingStrategy.SetType(Aws::GameLift::Model::RoutingStrategyType::NOT_SET);
                break;
    ...
    FRoutingStrategy &fromAWS(const Aws::GameLift::Model::RoutingStrategy &awsRoutingStrategy) {
        ...
        this->fleetId = awsRoutingStrategy.GetFleetId().c_str();

        this->message = awsRoutingStrategy.GetMessage().c_str();
