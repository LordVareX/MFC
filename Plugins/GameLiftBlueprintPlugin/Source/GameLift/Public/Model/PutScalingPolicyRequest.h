...
public:
    Aws::GameLift::Model::PutScalingPolicyRequest toAWS() const {
        ...
        switch(this->scalingAdjustmentType) {
            case EScalingAdjustmentType::NOT_SET:
                awsPutScalingPolicyRequest.SetScalingAdjustmentType(Aws::GameLift::Model::ScalingAdjustmentType::NOT_SET);
                break;
        ...
        switch(this->comparisonOperator) {
            case EComparisonOperatorType::NOT_SET:
                awsPutScalingPolicyRequest.SetComparisonOperator(Aws::GameLift::Model::ComparisonOperatorType::NOT_SET);
                break;
        ...
        switch(this->metricName) {
            case EMetricName::NOT_SET:
                awsPutScalingPolicyRequest.SetMetricName(Aws::GameLift::Model::MetricName::NOT_SET);
                break;
        ...
        switch(this->policyType) {
            case EPolicyType::NOT_SET:
                awsPutScalingPolicyRequest.SetPolicyType(Aws::GameLift::Model::PolicyType::NOT_SET);
                break;
