...
public:
    FAWSGameSessionConnectionInfo &fromAWS(const Aws::GameLift::Model::GameSessionConnectionInfo &awsGameSessionConnectionInfo) {
        this->gameSessionArn = awsGameSessionConnectionInfo.GetGameSessionArn().c_str();

        this->ipAddress = awsGameSessionConnectionInfo.GetIpAddress().c_str();

        this->dnsName = awsGameSessionConnectionInfo.GetDnsName().c_str();
