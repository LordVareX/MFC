...
public:
    FAWSGameSession &fromAWS(const Aws::GameLift::Model::GameSession &awsGameSession) {
        this->gameSessionId = awsGameSession.GetGameSessionId().c_str();

        this->name = awsGameSession.GetName().c_str();

        this->fleetId = awsGameSession.GetFleetId().c_str();
        ...
        this->ipAddress = awsGameSession.GetIpAddress().c_str();

        this->dnsName = awsGameSession.GetDnsName().c_str();
        ...
        this->creatorId = awsGameSession.GetCreatorId().c_str();

        this->gameSessionData = awsGameSession.GetGameSessionData().c_str();

        this->matchmakerData = awsGameSession.GetMatchmakerData().c_str();
