...
void ABattleMobaGameState::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME(ABattleMobaGameState, LatestEvent);
	DOREPLIFETIME(ABattleMobaGameState, WinningTeam);
	...
	DOREPLIFETIME(ABattleMobaGameState, CountdownTimer);
	DOREPLIFETIME(ABattleMobaGameState, RemainingGameTime);
	DOREPLIFETIME(ABattleMobaGameState, LobbyCheck);
	DOREPLIFETIME(ABattleMobaGameState, LobbyTimer);
	DOREPLIFETIME(ABattleMobaGameState, UpdateKDACheck);
	DOREPLIFETIME(ABattleMobaGameState, PlayerID);
	DOREPLIFETIME(ABattleMobaGameState, ArrayPlayerID);
