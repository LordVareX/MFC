...
#include "CharMovementComp.h"
#include "GameFramework/Character.h"

UCharMovementComp::UCharMovementComp(const FObjectInitializer & ObjectInitializer)
{
	
}

void UCharMovementComp::PhysFalling(float deltaTime, int32 Iterations)
{
		...
		else if (Hit.bBlockingHit)
		{
			...
			else
			{
				...
				if (subTimeTickRemaining > KINDA_SMALL_NUMBER && !bJustTeleported)
				{
					...
					Velocity = HasAnimRootMotion() && !CurrentRootMotion.HasOverrideVelocity() ? FVector(Velocity.X, Velocity.Y, 0.0f) : NewVelocity;
				}
